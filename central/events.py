...
@event('gh_push')
def GHPush(repo: str, pusher: str, before_sha: str, after_sha: str, commits:
           list, base_ref_name: str, ref_name: str, ref_type: str, created:
           bool, deleted: bool, forced: bool):
    return {'repo': repo,
            'pusher': pusher,
